...
void Adafruit_LIS3DH::setTrigger(bool a) {
  // if a == true (trigger 활성화)
  // trigger를 enable 한다
  // drdy를 disable 한다.
  //
  // else   (drdy 활성화)
...
void Adafruit_LIS3DH::read() {
  ...
  // if (range == LIS3DH_RANGE_16_G) divider = 1365; // different sensitivity at 16g
  // if (range == LIS3DH_RANGE_8_G) divider = 4096;
  // if (range == LIS3DH_RANGE_4_G) divider = 7840;
  // if (range == LIS3DH_RANGE_2_G) divider = 15987;
